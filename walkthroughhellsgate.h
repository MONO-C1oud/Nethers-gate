...
struct HellsGateShellcodeStub {
    string declarations;
    string decoding;
};

HellsGateShellcodeStub HellsGategenerateShellcodeStub(const string& binPath) {
    HellsGateShellcodeStub result;
    ...
    string dictWordsArray = "#define SHELLCODE_LENGTH " + to_string(words.size()) + "\n";
    ...
    decodingStub += "SIZE_T sDataSize = sizeof(shellcode);\n";
